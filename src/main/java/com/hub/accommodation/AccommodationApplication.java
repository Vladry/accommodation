...
/*
// с учетом установки lastVisitDate:
        ...
        udps.add(new UserDatingProfile(2L,  Sex.M, LocalDate.parse("1996-08-09"), ZonedDateTime.now(), Sex.ANY, 175, 0,   168, 18, 50, Country.CANADA, Country.UKRAINE, Country.CHINA, 2, 3, "romance is my all", null, null, null, null,  new ArrayList<>(List.of(Goals.MAKING_FRIENDS_ONLY , Goals.SPONSORSHIP_BASED_RELATIONSHIP)), null));
        ...
        udps.add(new UserDatingProfile(6L,  Sex.F, LocalDate.parse("1983-11-20"), ZonedDateTime.now(), Sex.M, 183, 160, 178, 18, 30, Country.USA, Country.USA, Country.NETHERLANDS, 3, 3, "porn", null, null, null,  new ArrayList<>(List.of(Interests.ANIME, Interests.BOATING)),  new ArrayList<>(List.of(Goals.TO_BUILD_FAMILY_WITH_CHILDREN, Goals.JOINT_RENT_OF_APARTMENT)), null));
        ...
        udps.add(new UserDatingProfile(19L, Sex.M, LocalDate.parse("1973-05-13"), ZonedDateTime.now(), Sex.F, 173, 150, 190, 16, 50, Country.USA, Country.UKRAINE, Country.SLOVAKIA, 1, 5, "nothing to say", null, "short height",  new ArrayList<>(List.of(Interests.BICYCLES, Interests.IT_COMPUTERS)),  new ArrayList<>(List.of(Interests.CARS, Interests.FISHING)), new ArrayList<>(List.of(Goals.I_AM_JUST_BORED, Goals.JOINT_RENT_OF_APARTMENT)), null));
*/

// выбросил lastVisitDate:
        udps.add(new UserDatingProfile(1L,  Sex.F, LocalDate.parse("1965-01-14"),     /*ZonedDateTime.now(),*/ Sex.M, 170, 190, 198, 18, 30, Country.USA, Country.USA, Country.USA, 1, 1, "nothing to say", "tall height", "smoking", null, null, null, null));
        ...
        udps.add(new UserDatingProfile(17L, Sex.M, LocalDate.parse("1973-05-13"),     /*ZonedDateTime.now(),*/ Sex.F, 178, 159, 188, 18, 30, Country.UKRAINE, Country.CANADA, Country.ESTONIA, 1, 3, "nothing to say", "caring, sky", "arrogance", null, null, null, null));
        udps.add(new UserDatingProfile(18L, Sex.F, LocalDate.parse("1989-09-01"),     /*ZonedDateTime.now(),*/ Sex.ANY, 165, 159, 188, 18, 30, Country.CANADA, Country.CANADA, Country.ESTONIA, 0, 1, "nothing to say", "caring, sky", "arrogance", null, null, null, null));
        udps.add(new UserDatingProfile(19L, Sex.M, LocalDate.parse("1973-05-13"),     /*ZonedDateTime.now(),*/ Sex.F, 173, 165, 190, 16, 50, Country.USA, Country.SLOVAKIA, Country.UKRAINE, 0, 5, "nothing to say", null, "short height",  new ArrayList<>(),  new ArrayList<>(), new ArrayList<>(), null));
